...
przyczyn losowych. Najsilniej skorelowane są kolumny opisujące
...
wybranych kolumnach ze zbioru danych. Zbiór danych został podzielony na
treningowy, walidujący i testujący. Celem było osiągnięcie jak
najmniejszej wartości RMSE przy przewidywaniu energii wytworzonej przez
ogniwa fotowoltaiczne w ujęciu godzinowym.
...
Zbiór nie zawiera wartości NA, zatem nie będzie konieczne zwracanie
uwagi na ich wystąpienie przy przetwarzaniu
...
Dane pochodzą z czujników ogniw fotowoltaicznych umieszczonych we
Włoszech. Opisane są przy użyciu 51 atrybutów, z czego część ma nazwy
angielskie, część włoskie, a kilka z nich opisana jest skrótami.  
...
#### 1. Usunięcie kolumny id, dodanie kolumny month
...
Najbardziej skorelowanym atrybutem jest 'irradiamento' (promieniowanie).
