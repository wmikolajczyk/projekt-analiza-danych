...
Jako model wybrano Random Forest. Do utworzenia regresora zostały wykorzystane mocno skorelowane atrybuty z atrybutem wynikowym 'kwh'. Strojenie parametrów modelu odbyło się w oparciu o walidacyjny zbiór danych. Celem strojenia było uzyskanie jak najmniejszej wartości RMSE.
